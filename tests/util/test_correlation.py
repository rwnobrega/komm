...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            [1.0, 1.0j, -1.0, -1.0j],
            [1.0j, -2.0, -3.0j, 4.0, 3.0j, -2.0, -1.0j],
        ),
    ],
)
def test_autocorrelation_general(seq, answer):
    L = len(seq)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            [1.0, 1.0j, -1.0, -1.0j],
            [4.0j, -4.0, -4.0j, 4.0, 4.0j, -4.0, -4.0j],
        ),
    ],
)
def test_cyclic_autocorrelation_general(seq, answer):
    L = len(seq)
    assert np.allclose(
