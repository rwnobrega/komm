...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            [[0o7, 0o5]],
            None,
            komm.to_binary(0x974B4459A5230EDE0B95CEEE67577B289B10E5F299954FCC6BCD698970BD55FE82A5E2BDD4DC8E3FF01C3F713E33EB2C9200, 400),
            komm.to_binary(0x1055CB0F07D8E51B703C77E5589DC1FCDBEC820C9A12A130C0, 200),
        ),
        (
            [[0o117, 0o155]],
            None,
            komm.to_binary(0x974B4459A5230EDE0B95CEEE67577B289B10E5F299954FCC6BCD698970BD55FE82A5E2BDD4DC8E3FF01C3F713E33EB2C9200, 400),
            komm.to_binary(0x1CA9300A1F7524061B0ADA89EC7E72D5906920081222BEDF0, 200),
        ),
        (
            [[0o31, 0o27, 0o00], [0o00, 0o12, 0o15]],
            None,
            komm.to_binary(0x7577B289B10E5F299954FCC6BCD698970BD55FE82A5E2BDD4DC8E3FF01C3F713E33EB2C9200, 300),
            komm.to_binary(0x4B592F74786E69C9E75CFA836CFFA14F917D51AAE2C9ED60, 200),
        ),
        (
            [[0o27, 0o31]],
            [0o27],
            komm.to_binary(0x974B4459A5230EDE0B95CEEE67577B289B10E5F299954FCC6BCD698970BD55FE82A5E2BDD4DC8E3FF01C3F713E33EB2C9200, 400),
            komm.to_binary(0x192F33AE3EBA2F9050B8577ADB33477613A7EA67CC7965DA40, 200),
        ),
        # fmt: on
    ],
)
...
def test_viterbi_stream_decoder_short_traceback(traceback_length, rng):
...
def test_viterbi_stream_decoder_parallel_transitions(rng):
