...
class LFSRSequence(BinarySequence):
    ...
    def maximum_length_sequence(
        ...
        r"""
        Constructs a maximum-length sequences of a given degree. The feedback polynomial $p(X)$ is chosen according to the following table of primitive polynomials.
