...
tab_configs = [
    ...
    {
        "name": "Beaulieu",
        "doc_title": "Beaulieu pulse",
        "doc_ref": "BeaulieuPulse",
        "pulse_class": komm.BeaulieuPulse,
        "ht_axis": (-8.0, 8.0, -0.3, 1.1),
        "hf_axis": (-1.1, 1.1, -0.1, 1.1),
        "R_axis": (-8.0, 8.0, -0.3, 1.1),
        "S_axis": (-1.1, 1.1, -0.1, 1.1),
    ...
    {
        "name": "Root-Beaulieu",
        "doc_title": "Root-Beaulieu pulse",
        "doc_ref": "BeaulieuPulse#root",
        "pulse_class": lambda rolloff: komm.BeaulieuPulse(rolloff).root(),
        "ht_axis": (-8.0, 8.0, -0.3, 1.3),
        "hf_axis": (-1.1, 1.1, -0.1, 1.1),
        "R_axis": (-8.0, 8.0, -0.3, 1.1),
        "S_axis": (-1.1, 1.1, -0.1, 1.1),
